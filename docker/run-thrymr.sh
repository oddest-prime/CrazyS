...
do
    ...
    do
        ...
        dyn_nse=`echo "scale=2;$k / 100" | bc | awk '{printf "%.2f", $0}'`

        cp rotors_gazebo/resource/crazyflie2_mpc1_fin.yaml rotors_gazebo/resource/crazyflie2_mpc1_dyn_${yamlname}.yaml
